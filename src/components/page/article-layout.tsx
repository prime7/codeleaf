...
export function ArticleLayout({ title, category, date, children }: ArticleLayoutProps) {
  return (
    <div className="pt-32 pb-20 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-3xl md:text-5xl font-bold text-foreground mb-12 leading-tight">{title}</h1>
